...
For on prem installation, follow these steps here: https://docs.pingidentity.com/pingidm/7.5/connector-reference/configure-connector.html#connector-wiz-REST.
